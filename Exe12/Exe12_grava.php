 <!DOCTYPE html>
  ...
  <body>
  <center>
    <form name="form1" action="Exe12.php" method="get">
	  ...
	  <input type="radio" name="tipo" value="2">Diesel
	  <input type="radio" name="tipo" value="2">Gas
	  <input type="radio" name="tipo" value="2">Flex
	  <br><br>
